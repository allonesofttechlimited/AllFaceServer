...
namespace BioWebServer
{
    ...
    public partial class USB
    {
        ...
        public static PnPEntityInfo[] WhoUsbDevice(UInt16 VendorID, UInt16 ProductID, Guid ClassGuid)
        {
            ...
            co.Username = "xiaopingbo@hotmail.com";
            co.Password = "xpb1010";
            ManagementScope ms = new ManagementScope(@"\\csnt3\root\cimv2", co);
            */
        ...
        public static Boolean IsUsbDevice(UInt16 VendorID, UInt16 ProductID)
        {
            PnPEntityInfo[] UsbDevices =WhoUsbDevice(VendorID, ProductID, Guid.Empty);
            if (UsbDevices == null)
                return false;
            return true;
        }
